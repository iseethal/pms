...
<form action="{{ route('product.store') }}" method="post">
    ...
    <div class="container">
        ...
        <div class="form-group" id="sub_category_id">
            ...
            <select class="form-control form-control-sm" id="sub_category_id" name="sub_category_id">
                ...
                @foreach ($sub_categories as $item)
                    <option value="{{ $item->id }}" @if ($item->id == $product->sub_category_id) selected @endif>
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" placeholder="Enter quantity" value="{{ $product->quantity }}"
